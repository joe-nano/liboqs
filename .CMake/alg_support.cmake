...
if(ARCH STREQUAL "x86_64" AND CMAKE_SYSTEM_NAME MATCHES "Linux")
    cmake_dependent_option(OQS_ENABLE_KEM_kyber_512_avx2 "" ON "OQS_USE_AVX2_INSTRUCTIONS;OQS_USE_BMI2_INSTRUCTIONS;OQS_ENABLE_KEM_KYBER" OFF)
endif()
cmake_dependent_option(OQS_ENABLE_KEM_kyber_768 "" ON "OQS_ENABLE_KEM_KYBER" OFF)
if(ARCH STREQUAL "x86_64" AND CMAKE_SYSTEM_NAME MATCHES "Linux")
    cmake_dependent_option(OQS_ENABLE_KEM_kyber_768_avx2 "" ON "OQS_USE_AES_INSTRUCTIONS;OQS_USE_AVX2_INSTRUCTIONS;OQS_USE_BMI2_INSTRUCTIONS;OQS_USE_POPCNT_INSTRUCTIONS;OQS_ENABLE_KEM_KYBER" OFF)
endif()
cmake_dependent_option(OQS_ENABLE_KEM_kyber_1024 "" ON "OQS_ENABLE_KEM_KYBER" OFF)
if(ARCH STREQUAL "x86_64" AND CMAKE_SYSTEM_NAME MATCHES "Linux")
    cmake_dependent_option(OQS_ENABLE_KEM_kyber_1024_avx2 "" ON "OQS_USE_AES_INSTRUCTIONS;OQS_USE_AVX2_INSTRUCTIONS;OQS_USE_BMI2_INSTRUCTIONS;OQS_USE_POPCNT_INSTRUCTIONS;OQS_ENABLE_KEM_KYBER" OFF)
endif()
cmake_dependent_option(OQS_ENABLE_KEM_kyber_512_90s "" ON "OQS_ENABLE_KEM_KYBER" OFF)
if(ARCH STREQUAL "x86_64" AND CMAKE_SYSTEM_NAME MATCHES "Linux")
    cmake_dependent_option(OQS_ENABLE_KEM_kyber_512_90s_avx2 "" ON "OQS_USE_AES_INSTRUCTIONS;OQS_USE_AVX2_INSTRUCTIONS;OQS_USE_BMI2_INSTRUCTIONS;OQS_USE_POPCNT_INSTRUCTIONS;OQS_ENABLE_KEM_KYBER" OFF)
endif()
cmake_dependent_option(OQS_ENABLE_KEM_kyber_768_90s "" ON "OQS_ENABLE_KEM_KYBER" OFF)
if(ARCH STREQUAL "x86_64" AND CMAKE_SYSTEM_NAME MATCHES "Linux")
    cmake_dependent_option(OQS_ENABLE_KEM_kyber_768_90s_avx2 "" ON "OQS_USE_AES_INSTRUCTIONS;OQS_USE_AVX2_INSTRUCTIONS;OQS_USE_BMI2_INSTRUCTIONS;OQS_USE_POPCNT_INSTRUCTIONS;OQS_ENABLE_KEM_KYBER" OFF)
endif()
...
if(ARCH STREQUAL "x86_64" AND CMAKE_SYSTEM_NAME MATCHES "Darwin|Linux")
    cmake_dependent_option(OQS_ENABLE_SIG_dilithium_3_avx2 "" ON "OQS_USE_AVX2_INSTRUCTIONS;OQS_USE_BMI2_INSTRUCTIONS;OQS_ENABLE_SIG_DILITHIUM" OFF)
endif()
